export default {
  ...
  store: {
    ...
    importPlaceholder: 'Пожалуйста, вставьте здесь JSON or CSV-данные',
    ...
    onlineImportWarning: 'Внимание! Проверьте источник JSON or CSV-файла!',
    downloadError: 'Проверьте состояние сети и правильность JSON or CSV-файла',
  },
}
