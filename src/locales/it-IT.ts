export default {
  ...
  store: {
    ...
    importPlaceholder: 'Please paste the JSON or CSV data here',
    ...
    onlineImportWarning: 'Note: Please check the JSON or CSV file source!',
    downloadError: 'Please check the network status and JSON or CSV file validity',
  },
}
